...
export class Test1712920001882 implements MigrationInterface {
  name = 'Test1712920001882'
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "basket_products" ("id" SERIAL NOT NULL, "basketId" integer NOT NULL, "productId" integer NOT NULL, "quantity" integer NOT NULL, "color" character varying NOT NULL, CONSTRAINT "REL_5e913ec216ed0cde0d99c8bbae" UNIQUE ("basketId"), CONSTRAINT "PK_b6245f9f34546a14637d4deb7e6" PRIMARY KEY ("id"))`
    )
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "orders" ("id" SERIAL NOT NULL, "userId" integer NOT NULL, CONSTRAINT "PK_710e2d4957aa5878dfe94e4ac2f" PRIMARY KEY ("id"))`
    )
    await queryRunner.query(
